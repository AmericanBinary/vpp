...
docker cp ${CID}:/root/go/src/github.com/americanbinary/vpp/cmd/contiv-init/contiv-init binaries/
docker cp ${CID}:/root/go/src/github.com/americanbinary/vpp/cmd/contiv-agent/contiv-agent binaries/
